...
class PS_Astro_Strong_ECG_01(_PS_Astro_Strong):
...
class PS_Astro_Strong_ECG_02(_PS_Astro_Strong):
...
_param_spaces_dict = {
    ...
    'PS_Astro_Strong_ECG_01': PS_Astro_Strong_ECG_01,
    'PS_Astro_Strong_ECG_02': PS_Astro_Strong_ECG_02,
}